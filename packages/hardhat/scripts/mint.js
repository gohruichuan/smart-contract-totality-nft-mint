...
try{
  ...
  console.log("readFileSync currentIndex ", currentIndex);
}catch(e){
  currentIndex = 0
}
...
const main = async () => {
  ...
  const localProvider = new ethers.providers.StaticJsonRpcProvider("https://rinkeby.infura.io/v3/460f40a260564ac4a4f4b3fffb032dad");
  ...
  const yourCollectible = await ethers.getContract("Totality", deployer);
  //await Totality.transferOwnership("0x6e92B3775A8459c39d6a4a8C798efB107385572d");
  ...
  for(let e in allEvents){
    ...
    if(parseInt(e)==currentIndex){
      ...
      // const readableIndex = (currentIndex + 1).toString();
      // const buffalo = {
      //   "description": "The dome is ......",
      //   "external_url": "https://austingriffith.com/portfolio/paintings/",// <-- this can link to a page for the specific file too
      //   // "image": "https://api-nft-placeholder.herokuapp.com/api/metadata/" +currentIndex.toString(),
      //   "image": "https://api-nft-placeholder.herokuapp.com/api/metadata/0",
      //   "name": "The Dome #" + readableIndex,
      //   "attributes": [
      //   ]
      // }
      ...
      const tokenURI = currentIndex.toString();
      console.log("MINTING!!!",allEvents[e].args.to, tokenURI)
      const cb = await yourCollectible.mintItem(allEvents[e].args.to, tokenURI)
      console.log("cb ", cb);
...
/*  const toAddress = "0x6e92B3775A8459c39d6a4a8C798efB107385572d"
  ...
  console.log("Transferring Ownership of Totality to "+toAddress+"...")
